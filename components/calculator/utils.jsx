...
-33 -25 -35 -23 -2 2 -1 18 2 35 7 32 25 40 52 23z"
      ...
      {hidebtn ? (
        ...
        <button
          ...
          className="text-sm rounded flex flex-row-reverse gap-2 items-center px-3 md:px-5 py-1.5 border border-current  absolute dark:hover:text-white hover:text-zinc-800 text-zinc-600  dark:text-zinc-400 right-3 md:right-5 top-3 md:top-5"
        >
