...
export function ProfileCard22({ userDetail, children, hidebtn, keyval }) {
  return (
...
-33 -25 -35 -23 -2 2 -1 18 2 35 7 32 25 40 52 23z"
      ...
      {!hidebtn && (
        <button
          ...
          className="absolute right-0  duration-100 ease-in hover:bg-white hover:text-zinc-800 dark:hover:text-zinc-800  text-zinc-500 dark:text-white p-1 rounded-full"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            className="h-4 w-4"
