...
const PurpleEffect = () => {
  ...
  const createAirEffect = (context, x, y) => {
    ...
    const transparency =
      Math.abs(canvasRef.current.width / 2 - x) / (canvasRef.current.width / 2);

    gradient.addColorStop(0, `rgba(51, 0, 51, ${transparency})`);
